// generated on 2017-02-17 using generator-webapp 2.3.2
...
gulp.task('styles', () => gulp.src('app/styles/*.scss')
  ...
  .pipe($.autoprefixer({ browsers: ['> 1%', 'last 2 versions', 'Firefox ESR', 'IE >= 11'] }))
...
gulp.task('fonts', () => gulp.src(mainBowerFiles('**/*.{eot,svg,ttf,woff,woff2}', () => {})
  .concat('app/fonts/**/*'))
